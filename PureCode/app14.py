...
def print_receipt():
    try:
        ...
        # Calculate right-aligned seat position
        # Assuming 32 character width receipt paper
        seat_position = 32 - len(seat)  # Right-align calculation
        
        # Build receipt content
        receipt_lines = [
            # Right-aligned seat number (bold and large)
            b' ' * seat_position + BOLD_LARGE + seat.encode('utf-8') + RESET,
