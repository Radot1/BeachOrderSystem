...
const menuData = {
    drinks: [
        ...
        { name: "Coca Cola", description: "Classic or Zero", basePrice: 2, options: [] },
        { name: "Fanta", description: "Lemon or Orange", basePrice: 2, options: [] },
        { name: "Sprite", description: "", basePrice: 2, options: [] },
        { name: "Schweppes", description: "Pomegranate, Grapefruit, or Lemon", basePrice: 2, options: [] },
        { name: "Green Tea (Can)", description: "", basePrice: 2, options: [] },
        { name: "Red Bull", description: "", basePrice: 3.5, options: [] },
        { name: "Ice Tea", description: "Lemon or Peach", basePrice: 2, options: [] },
        ...
        { name: "Freddo Espresso", description: "", basePrice: 3, options: [] },
        { name: "Freddo Cappuccino", description: "", basePrice: 3.5, options: [] },
        { name: "Frappe", description: "", basePrice: 3, options: [] },
        { name: "Greek Coffee Double", description: "", basePrice: 3, options: [] },
        { name: "Vodka Lemon/Cola", description: "", basePrice: 6.5, options: [] },
        { name: "Bacardi Cola", description: "", basePrice: 6.5, options: [] },
        { name: "Gin Tonic", description: "", basePrice: 6.5, options: [] },
        { name: "Whiskey", description: "", basePrice: 6.5, options: [] },
        { name: "Wine (Small Bottle)", description: "White, Red, Sweet, Rose", basePrice: 3.5, options: [] },
        { name: "Cocktail", description: "Mojito, Daquiri, Caipirinha, Aperol", basePrice: 8, options: [] }
    ],
    Food: [
        {
            name: "Burger",
        ...
        { name: "Baguette - Ham/Turkey", description: "Cheese, ham/turkey, lettuce, tomato, mayo", basePrice: 4.5, options: [] },
        { name: "Baguette - Chicken", description: "Cheese, chicken, tomato, cucumber, sauce", basePrice: 5, options: [] },
        { name: "Baguette - Feta", description: "Feta, tomato, olive paste, oregano, olive oil", basePrice: 4.5, options: [] },
        { name: "Chicken Club Sandwich", description: "Cheese, tomato, cucumber, sauce, chips", basePrice: 5, options: [] },
        { name: "Arabic Pita", description: "Cheese, chicken, lettuce, tomato, mustard sauce", basePrice: 4.5, options: [] },
        { name: "Toast", description: "Cheese, ham/turkey", basePrice: 3, options: [] }
    ],
    Smoothies: [
        { name: "Strawberry", description: "Fresh milk or almond milk, greek yogurt", basePrice: 4.5 },
        { name: "Banana, Honey", description: "", basePrice: 4.5 },
        { name: "Strawberry, Banana, Apple", description: "", basePrice: 5 },
        { name: "Mango, Apple, Strawberry, Honey", description: "", basePrice: 5 },
        { name: "Pineapple, Banana, Mango", description: "", basePrice: 5 }
    ],
    Slushies: [
    ...
    "Fresh Juices": [
        { name: "Orange", description: "", basePrice: 3.5 },
        { name: "Mixed Fruits", description: "", basePrice: 4.5 },
        { name: "Apple, Carrot, Orange", description: "", basePrice: 4.5 },
        { name: "Celery, Apple, Carrot, Orange", description: "", basePrice: 5 },
        { name: "Beetroot, Apple, Ginger, Lemon", description: "", basePrice: 5 },
        { name: "Coconut, Carrot, Ginger, Apple, Lemon", description: "", basePrice: 5 }
    ],
    "Yogurt Bowls": [
        { name: "Kiwi, Strawberry, Seeds", description: "", basePrice: 4.5 },
        { name: "Chocolate, Banana, Honey", description: "", basePrice: 5 },
        { name: "Honey, Walnuts", description: "", basePrice: 4.5 }
    ]
};
...
<div class="mb-4">
    <div class="flex space-x-2 overflow-x-auto pb-2">
        ...
        <button onclick="selectCategory('Smoothies')" class="category-btn px-3 py-1.5 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-xs">
            <i class="fas fa-blender mr-1"></i> Smoothies
        </button>
        <button onclick="selectCategory('Slushies')" class="category-btn px-3 py-1.5 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-xs">
            <i class="fas fa-snowflake mr-1"></i> Slushies
        </button>
        <button onclick="selectCategory('Milkshakes')" class="category-btn px-3 py-1.5 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-xs">
            <i class="fas fa-ice-cream mr-1"></i> Milkshakes
        </button>
        <button onclick="selectCategory('Fresh Juices')" class="category-btn px-3 py-1.5 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-xs">
            <i class="fas fa-glass-whiskey mr-1"></i> Juices
        </button>
        <button onclick="selectCategory('Yogurt Bowls')" class="category-btn px-3 py-1.5 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-xs">
            <i class="fas fa-bowl-food mr-1"></i> Yogurt
        </button>
    </div>
</div>
