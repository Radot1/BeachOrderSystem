    ...
    <div id="menu-items" class="mb-4 max-h-60 overflow-y-auto pr-1">
        ...
        <div id="drinks" class="category-content">
            <div class="grid grid-cols-1 gap-1">
                <!-- Example drink with sub-options -->
                <div class="relative">
                    <button onclick="toggleSubOptions('tropical-punch')" class="flex justify-between items-center p-2 bg-blue-50 hover:bg-blue-100 rounded-lg transition text-left w-full">
                        <div class="truncate">
                    ...
                    <div id="tropical-punch" class="sub-options hidden bg-blue-50 rounded-b-lg p-2 border-t border-blue-100">
                        <button onclick="addToOrder('Tropical Punch (Sugar)', 8)" class="flex justify-between items-center p-1 px-2 hover:bg-blue-100 rounded text-left w-full text-sm">
                            <span>With Sugar</span>
                        </button>
                        <button onclick="addToOrder('Tropical Punch (No Sugar)', 8)" class="flex justify-between items-center p-1 px-2 hover:bg-blue-100 rounded text-left w-full text-sm">
                            <span>No Sugar</span>
                        </button>
                    </div>
                </div>
                
                <!-- Another example with sub-options -->
                <div class="relative">
                    <button onclick="toggleSubOptions('cappuccino')" class="flex justify-between items-center p-2 bg-blue-50 hover:bg-blue-100 rounded-lg transition text-left w-full">
                        <div class="truncate">
                            <h4 class="font-medium text-blue-800 text-sm truncate">Cappuccino</h4>
                            <p class="text-xs text-blue-600 truncate">Espresso with steamed milk</p>
                        </div>
                        <span class="font-bold text-blue-700 text-sm ml-2">$5</span>
                    </button>
                    <div id="cappuccino" class="sub-options hidden bg-blue-50 rounded-b-lg p-2 border-t border-blue-100">
                        <button onclick="addToOrder('Cappuccino (Sugar)', 5)" class="flex justify-between items-center p-1 px-2 hover:bg-blue-100 rounded text-left w-full text-sm">
                            <span>With Sugar</span>
                        </button>
                        <button onclick="addToOrder('Cappuccino (No Sugar)', 5)" class="flex justify-between items-center p-1 px-2 hover:bg-blue-100 rounded text-left w-full text-sm">
                            <span>No Sugar</span>
                        </button>
                        <button onclick="addToOrder('Cappuccino (Extra Sugar)', 5)" class="flex justify-between items-center p-1 px-2 hover:bg-blue-100 rounded text-left w-full text-sm">
                            <span>Extra Sugar (+$0.50)</span>
                            <span class="font-bold text-blue-700 text-xs">$5.50</span>
                        </button>
                    </div>
                </div>
                
                <!-- Simple drink without sub-options -->
                <button onclick="addToOrder('Bottled Water', 3)" class="flex justify-between items-center p-2 bg-blue-50 hover:bg-blue-100 rounded-lg transition text-left w-full">
                    <div class="truncate">
                        <h4 class="font-medium text-blue-800 text-sm truncate">Bottled Water</h4>
                        <p class="text-xs text-blue-600 truncate">Spring water, 500ml</p>
                    </div>
        ...
        <div id="food" class="category-content hidden">
            <div class="grid grid-cols-1 gap-1">
                <!-- Example food item with sub-options -->
                <div class="relative">
                    <button onclick="toggleSubOptions('fish-tacos')" class="flex justify-between items-center p-2 bg-blue-50 hover:bg-blue-100 rounded-lg transition text-left w-full">
                        <div class="truncate">
                    ...
                    <div id="fish-tacos" class="sub-options hidden bg-blue-50 rounded-b-lg p-2 border-t border-blue-100">
                        <button onclick="addToOrder('Fish Tacos (Spicy)', 12)" class="flex justify-between items-center p-1 px-2 hover:bg-blue-100 rounded text-left w-full text-sm">
                            <span>Spicy Version</span>
                        </button>
                        <button onclick="addToOrder('Fish Tacos (Mild)', 12)" class="flex justify-between items-center p-1 px-2 hover:bg-blue-100 rounded text-left w-full text-sm">
                            <span>Mild Version</span>
                        </button>
                        <button onclick="addToOrder('Fish Tacos (No Slaw)', 12)" class="flex justify-between items-center p-1 px-2 hover:bg-blue-100 rounded text-left w-full text-sm">
                            <span>No Slaw</span>
                        </button>
                    </div>
                </div>
