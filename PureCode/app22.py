...
const menuData = {
    ...
    Slushies: [
        { name: "Slushies", description: "Strawberry/Lemon", basePrice: 4, options: [
            { label: "Strawberry", priceAdjustment: 0 },
            { label: "Lemon", priceAdjustment: 0 }
            ]}
    ],
    Milkshakes: [
        { name: "Milkshakes", description: "Strawberry/Vanilla/Chocolate", basePrice: 4.5, options: [
            { label: "Strawberry", priceAdjustment: 0 },
            ...
            <div class="space-y-4">
                ...
                <div class="bg-white rounded-xl shadow-md p-4 border border-blue-200">
                    ...
                    <div class="mb-4">
                        <!-- First Row -->
                        <div class="flex flex-wrap gap-2 mb-2">
                            <button onclick="selectCategory('Coffees')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                                <i class="fas fa-mug-saucer"></i> Coffees
                            </button>
                            <button onclick="selectCategory('Fresh Juices')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                                <i class="fas fa-glass-whiskey"></i> Juices
                            </button>
                            <button onclick="selectCategory('Smoothies')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                                <i class="fas fa-blender"></i> Smoothies
                            </button>
                            <button onclick="selectCategory('Milkshakes')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                        ...
                        <div class="flex flex-wrap gap-2 mb-2">
                            ...
                            <button onclick="selectCategory('Slushies')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                                <i class="fas fa-snowflake"></i> Slushies
                            </button>
                            <button onclick="selectCategory('Soft Drinks')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                                <i class="fas fa-glass-whiskey"></i> Soft Drinks
                            </button>
                            <button onclick="selectCategory('Beers')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                                <i class="fas fa-beer-mug-empty"></i> Beers
                            </button>
                            <button onclick="selectCategory('Spirits')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <button onclick="selectCategory('Snacks')" class="category-btn active px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                                <i class="fas fa-pizza-slice"></i> Snacks
                            </button>
                            <button onclick="selectCategory('Baguets')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                                <i class="fas fa-bread-slice"></i> Baguets
                            </button>
                            <button onclick="selectCategory('Salads')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                                <i class="fas fa-bowl-food"></i> Salads
                            </button>
                            <button onclick="selectCategory('Yogurt Bowls')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
                                <i class="fas fa-bowl-food"></i> Yogurt
                            </button>
                            <button onclick="selectCategory('Cocktails')" class="category-btn px-3 py-3 rounded-lg bg-blue-50 text-blue-800 font-medium whitespace-nowrap text-sm">
...
def print_receipt():
    try:
        ...
        # Add items with quantities and custom text
        for item in order_data['items']:
            ...
            line += f" - €{item['price'] * item.get('quantity', 1):.2f}"
            receipt_lines.append(line.encode('utf-8'))
        
        # Add footer
        receipt_lines.extend([
            b"\n\n" + ("-"*32).encode('utf-8'),
            f"\nSUBTOTAL: €{sum(item['price'] * item.get('quantity', 1) for item in order_data['items']):.2f}".encode('utf-8'),
            f"\nTOTAL: €{order_data['total']:.2f}".encode('utf-8'),
