...
<head>
    ...
    if (window.innerWidth < 1024 && !orderPanelOpen) {
        ...
        function submitOrder() {
            ...
            // Read notes from both desktop and mobile textareas.
            ...
            .then(data => {
                if (data.status === 'success') {
                    ...
                    // Clear both notes fields after successful submission
            ...
            <div class="hidden lg:block lg:sticky lg:top-4 h-fit">
                <div class="bg-white rounded-xl shadow-lg p-4 border border-blue-200 h-[calc(100vh-140px)] flex flex-col">
                    ...
                    <div class="flex items-center justify-center my-3">
                        ...
                        <label for="pay-by-card" class="ml-2 block text-sm font-medium text-blue-800">
                            Pay by Card
                        </label>
                    </div>
...
def print_receipt():
    try:
        ...
        if pay_by_card:
            receipt_lines.append(BOLD + encode_escpos("\n\n*** PAY BY CARD ***") + RESET)
